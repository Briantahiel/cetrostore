...
export default function CreditCheckSection() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const message = [
      "Hola Brian Gómez, quiero consultar mi estado crediticio para financiar una moto.",
      "",
      ...
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        <div className="flex flex-col justify-center">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
            Revisamos tu credito antes de elegir la moto
          </h2>
          <p className="mt-4 text-sm font-medium leading-6 text-slate-300">
            ...
            enviar. Te atiende Brian Gómez, asesor comercial.
          </p>
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="flex flex-col gap-2 text-sm font-black sm:col-span-2">
              Telefono
              {/* <input
                type="tel"
                value={form.telefono}
