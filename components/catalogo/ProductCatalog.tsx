...
const cilindradaRanges = [
  ...
  { label: "Más de 250cc", value: "251-up", min: 251, max: Infinity },
];
  ...
  return (
    <section className="px-4 py-10 sm:px-8 lg:px-10">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-950">
          <div className="flex flex-col gap-4 bg-slate-950 px-5 py-6 text-white sm:flex-row sm:items-end sm:justify-between sm:px-7">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm font-semibold leading-6 text-slate-300">
                Filtrá por marca y cilindrada. Consultá disponibilidad,
        ...
        <div className="mb-8 rounded-lg border border-slate-200 bg-white p-5 shadow-lg shadow-slate-950/5 dark:border-slate-700 dark:bg-slate-900">
          <div className="mb-4 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
            ...
            <button
              ...
              className="w-fit rounded-lg border border-slate-300 px-4 py-2 text-sm font-black text-slate-800 transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 dark:border-slate-600 dark:text-slate-100 dark:hover:border-cyan-400 dark:hover:bg-slate-800 dark:hover:text-cyan-300"
            >
              Limpiar filtros
            </button>
          </div>
              ...
              <button
                ...
                className={`rounded-lg border px-4 py-2 text-sm font-black transition ${
                  selectedBrand === ""
                    ...
                    : "border-slate-300 bg-white text-slate-800 hover:border-blue-300 hover:bg-blue-50 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 dark:hover:border-cyan-400 dark:hover:bg-slate-800"
                }`}
              >
                Todas
              </button>
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-xs font-black uppercase tracking-wide text-slate-700 dark:text-slate-300">
        ...
        {paginatedProducts.length === 0 && (
          <div className="mt-8 rounded-lg border border-dashed border-slate-300 bg-white p-8 text-center text-sm font-bold text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
        ...
        <div className="mt-8 flex items-center justify-between gap-4">
          <button
            ...
            className="rounded-lg border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-slate-800 shadow-sm transition hover:border-blue-300 hover:text-blue-700 disabled:cursor-not-allowed disabled:opacity-40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-cyan-400 dark:hover:text-cyan-300"
          >
            Anterior
          </button>
        ...
        <div className="mt-8 rounded-lg border border-slate-200 bg-white p-5 text-center text-sm font-semibold text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
          ¿No encontrás el modelo que buscás? Consultanos por el ingreso de
